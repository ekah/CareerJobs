...
public partial class Job_Job_Facility : System.Web.UI.Page
{
    ...
    /// <summary>
    ///  Remember to ASK - Session of Login,User
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Login"] != null)
        {
            if (Session["Login"].ToString().ToUpper() == _hrsession)
            {
                rgFacilityJobs.MasterTableView.GetColumn("DeleteColumn").Display = false;
            }
    ...
    protected void rgFacilityJobs_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                imgdelete.OnClientClick = "javascript:return confirm('Jobs Associated with " + lblFacility.Text + " facility.Do you want to delete this facility and jobs?')";
