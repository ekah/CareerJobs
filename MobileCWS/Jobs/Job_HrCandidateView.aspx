<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Jobs/AdminMasterPage.Master" CodeFile="Job_HrCandidateView.aspx.cs" Inherits="Jobs_Job_HrCandidateView" %>
...
<asp:Content ID="ct_adminjobs" ContentPlaceHolderID="MainContent" runat="server">
 <style>
    ...
    <asp:UpdatePanel ID="upJob_HrCandidateView" runat="server">
        <ContentTemplate>
                                                ...
                                                <div class="gridpanelpadd">
                                                    <div class="gridpanel">
                                                        <telerik:RadGrid ID="rgcandidate" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                            ...
                                                            OnNeedDataSource="rgcandidate_NeedDataSource" OnItemDataBound="rgcandidate_ItemDataBound">
                                                            <MasterTableView CommandItemDisplay="Top" InsertItemDisplay="Top" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="View Candidate Details" SortExpression="candidatename"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Job_HrCandidateDetails.aspx?ClientId=<%#Eval("ClientId") %>&Id=<%#Eval("Aid") %>'
                                                                                target="_blank">
