...
public partial class Jobs_Job_AllHospital : System.Web.UI.Page
{
    Job_JobsBAL objJobsBAL = new Job_JobsBAL();
    protected void Page_Load(object sender, EventArgs e)
    {
       
       BindHospitalByChar(string.Empty);
    }

    public void BindHospitalByChar(string chr)
    {
        DataSet ds = objJobsBAL.SelectByHospitalByChar(chr);
