...
public partial class Job_Job_Apply : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/Jobs/Job_SearchDescription.aspx?return=1&cid=" + Request.QueryString["cid"].ToString() + "&JobId=" + _jobid);
    }
