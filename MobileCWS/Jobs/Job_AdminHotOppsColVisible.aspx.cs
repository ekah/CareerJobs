...
public partial class Jobs_Job_AdminHotOppsColVisible : System.Web.UI.Page
{
    ...
    protected void rgHotoppsjobs_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        rgHotoppsjobs.DataSource = GridDataSource();
    }
    private DataSet GridDataSource()
    {
        DataSet ds = new DataSet();    
        ds = objHotOppsColVisibleBAL.HOColVisibleSelectByVisibleByAll();
        return ds;
    }
    protected void rgHotoppsjobs_UpdateCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        GridEditableItem edititem = e.Item as GridEditableItem;
        _hid = Convert.ToInt32(edititem.OwnerTableView.DataKeyValues[edititem.ItemIndex]["HId"].ToString());
    ...
    protected void rgHotoppsjobs_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
        ...
        else
        {
            ...
            {
                DataSet dsClient = objHotOppsColVisibleBAL.ClientAlreadyExistsHO(_clientid);
                if (dsClient.Tables.Count > 0 && dsClient.Tables[0].Rows.Count > 0)
                {
                    ShowPopUpMsg("Client Already Exists");
                }
                else
                {
                    objHotOppsColVisibleBAL.InsertUpdateHOColVisible(_hid, _countrybool, _statebool, _citybool, _facilitybool, _specialitybool, _postdatebool, _clientid, _whocreated, _whoupdated);
    ...
    protected void rgHotoppsjobs_ItemDataBound(object sender, GridItemEventArgs e)
    {
    ...
    protected void rgHotoppsjobs_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
