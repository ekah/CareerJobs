<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Jobs/SubAdminMasterPage.Master" CodeFile="Job_HotOppsColVisible.aspx.cs" Inherits="Job_Job_HotOppsColVisible" %>

<asp:Content ID="ct_adminjobs" ContentPlaceHolderID="MainContent" runat="server">

<script language="javascript" type="text/javascript">
    function ValidateModuleList(source, args) {
        var chkListModules = document.getElementById('<%= chkHotopps.ClientID %>');
 ...
 <div class="innerpanel">
    <div class="adminpanel">
        ...
        <div class="adminpage_cntbgmid">
            ...
            <%--<div class="candidatedetails_subheadingbg">HotOpps Visibility</div>--%>
            <div class="candidatecntbg_mid_cnt">
                <div>
                    <asp:CheckBoxList ID="chkHotopps" runat="server" RepeatDirection="Vertical">
