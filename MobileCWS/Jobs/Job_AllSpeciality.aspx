<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Jobs/AdminMasterPage.Master"
    CodeFile="Job_AllSpeciality.aspx.cs" Inherits="Jobs_Job_AllSpeciality" %>
                                            ...
                                            <td width="24" valign="top" align="right">
                                                <table width="24" cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td width="30" height="20" align="center" onclick="document.location='Job_GSOrder.aspx'"
                                                                onmouseout="this.className='bg_lightgreen3 border_green'" onmouseover="this.className='bg_green border_green txt_white'"
                                                                style="cursor: pointer; border-right: none;" class="bg_lightgreen3 border_green">
                                                                G
                                                            </td>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="bg_grey" style="font-weight: bold;">
                                                                Speciality starting with: <span class="txt_16 bold">All</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
