<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Jobs/HrMasterPage.Master" CodeFile="Job_XSOrder.aspx.cs" Inherits="Jobs_Job_XSOrder" %>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="bg_grey" style="font-weight: bold;">
                                                                Speciality starting with: <span class="txt_16 bold">X</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
