...
public partial class Job_Job_CandidateView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("Job_Login.aspx");
        }
        if (Session["Login"] != null)
        {
            if (Session["Login"].ToString().ToUpper() == _hrsession)
            {
                rgcandidate.MasterTableView.GetColumn("DeleteColumn").Display = false;
            }
        }
    }
