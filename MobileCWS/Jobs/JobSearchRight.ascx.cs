...
public partial class Job_JobSearchRight : System.Web.UI.UserControl
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Job_SearchResults.aspx?cid=" + _clientid + "&facility=" + strFacility.Replace("&", "") + "&speciality=" + strSpeciality.Replace("&", "") + "&country=" + strCountry.Replace("&", "") + "&state=" + strState.Replace("&", "") + "&city=" + strCity.Replace("&", "") + "&keyword=" + strkeyword);
