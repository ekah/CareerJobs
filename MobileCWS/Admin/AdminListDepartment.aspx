<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMedAppointment.master"
    AutoEventWireup="true" CodeFile="AdminListDepartment.aspx.cs" Inherits="Admin_AdminListDepartment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphAdminMaster" runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="rgAdminListDepartment">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgAdminListDepartment" LoadingPanelID="RadAjaxLoadingPanel1" />
    ...
    <div align="left">
        <div id="divListDepartment" style="width: 1300px;" align="left">
            <div id="divAdminListDepartment" runat="server" align="left">
                <table cellpadding="0px" cellspacing="0px" border="0px">
                    ...
                    <tr>
                        <td valign="top" width="80%" align="left">
                            <telerik:RadGrid ID="rgAdminListDepartment" GridLines="None" runat="server" AllowAutomaticDeletes="False"
                                AllowFilteringByColumn="True" Width="100%" OnItemDataBound="rgAdminListDepartment_ItemDataBound"
                                AllowAutomaticInserts="False" PageSize="100" AllowAutomaticUpdates="False" AllowPaging="True"
                                OnNeedDataSource="rgAdminListDepartment_NeedDataSource" AutoGenerateColumns="False"
                                OnDeleteCommand="rgAdminListDepartment_DeleteCommand" OnInsertCommand="rgAdminListDepartment_InsertCommand"
                                OnUpdateCommand="rgAdminListDepartment_UpdateCommand">
                                <PagerStyle Mode="NextPrevAndNumeric" />
                                <GroupingSettings CaseSensitive="false" />
                                <MasterTableView Width="100%" CommandItemDisplay="TopAndBottom" DataKeyNames="DepartmentId"
                                    ...
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="DepartmentName" HeaderText="Department Name"
                                            SortExpression="DepartmentName" HeaderStyle-Width="200px" UniqueName="DepartmentName"
                                        ...
                                        <telerik:GridButtonColumn ConfirmText="Selected department may be mapped with some diagnosis!<br/>Are you sure to Delete?'"
                                            ConfirmDialogType="Classic" HeaderStyle-Width="50px" ConfirmTitle="Delete" ButtonType="ImageButton"
                                            CommandName="Delete" HeaderText="Delete" UniqueName="Delete">
