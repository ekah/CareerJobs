...
public partial class Control_TopMenu : System.Web.UI.UserControl
{
    ...
    private void DefaultSettings()
    {
        if (Session["SignInId"] != null)
        {
            ...
            lbtnFeatures.Visible = true;
            lbtnFaq.Visible = true;
        }
        else
        {
            ...
            else if((Request.Url.AbsolutePath.Contains("Disclaimer.aspx"))||(Request.Url.AbsolutePath.Contains("Beta.aspx"))||(Request.Url.AbsolutePath.Contains("ConfirmByEmail.aspx")))
            {
                lbtnHospitalLogin.Visible = false;
    ...
    protected void lbtnSignOut_Click(object sender, EventArgs e)
    {
        ...
        Session["SignInLoginIdTemp"] = null; //for swaping session temp
        Session["SignInIdTemp"] = null;
