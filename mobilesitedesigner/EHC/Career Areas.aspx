    ...
    <div class="mainwrapper">
        ...
        <div class="contentwrapper">          
            <ul class="menu">
                ...
                <li><a href="Nursing.aspx" data-role="button" data-iconpos="right" data-icon="star" data-ajax="false">Nursing</a> </li>
                
                <li><a href="Allied Health.aspx" data-role="button" data-iconpos="right" data-icon="star" data-ajax="false">Allied Health</a> </li>
                
                <li><a href="Emergency Care.aspx" data-role="button" data-iconpos="right" data-icon="star" data-ajax="false">Emergency Care</a> </li>
                
            </ul>
            <h1 style="margin-left: 10px;">Career Areas </h1>                 
            <p style="padding: 10px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec arcu ligula, luctus non aliquam vitae, convallis sed nibh. Maecenas faucibus euismod hendrerit. Aenean at blandit lacus. Morbi sed est augue, id egestas est. Aliquam erat volutpat. Donec turpis purus, hendrerit at tincidunt et, cursus sit amet erat. Duis vulputate luctus tellus nec faucibus. <br><br>Donec dignissim tempus facilisis. Nunc id purus eu nulla egestas luctus in non neque. Mauris tempus, risus convallis viverra ornare, purus lorem feugiat leo, quis mattis risus libero a risus. Duis id libero non felis congue iaculis eu non tortor. Nulla nec sem ac nisl bibendum facilisis iaculis vitae tellus. Fusce nec sem lorem. Sed tincidunt sollicitudin quam, sit amet dapibus tellus gravida ac.
<br><br>
Donec sodales neque vitae ipsum cursus porta sollicitudin enim adipiscing. Sed venenatis augue urna. Donec quis mauris libero, vel blandit nisi. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla viverra pellentesque mi non semper. Nam vitae leo pharetra neque posuere bibendum. Cras ultrices congue sapien, et fermentum ipsum posuere condimentum. Vestibulum placerat fermentum nulla, eu fringilla nulla pellentesque quis. Fusce et arcu nibh. Vivamus metus felis, aliquam mattis vehicula nec, lacinia et libero. Nunc nulla justo, gravida non rutrum vel, varius at neque.</p>
            <br />
            <br />
            <br />
            <div class="social">
