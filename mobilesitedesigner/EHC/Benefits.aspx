...
<body>
    <div class="mainwrapper">
        ...
        <div class="bannerwrapper">
            <!--Image Banner-->
            <div class="banner">
                <img src="../contentimages/benefits_banner.jpg" width="320" height="160" />
            </div>
        </div>
            ...
            { %>
                <div class="advSearch">
                    ...
                    <div class="HomeSearch">
                        ...
                        <input type="hidden" value="Benefits" name="page" />
        ...
        <div class="contentwrapper">          
            <ul class="menu">
                ...
                <li><a href="Working at Exempla 1 .aspx" data-role="button" data-iconpos="right" data-icon="star" data-ajax="false">Working at Exempla 1 </a> </li>
                
                <li><a href="Working at Exempla 1 .aspx" data-role="button" data-iconpos="right" data-icon="star" data-ajax="false">Working at Exempla 1 </a> </li>
                
            </ul>
            <h1 style="margin-left: 10px;">Benefits </h1>                 
            <p style="padding: 10px;">Donec consectetur consectetur fringilla. Maecenas tortor urna, cursus eu consectetur ac, euismod sed justo. In hac habitasse platea dictumst. Aenean commodo, velit at ornare sollicitudin, ipsum lacus rutrum massa, sodales ultricies lorem magna non lacus. Etiam at accumsan augue. Proin dolor tortor, sodales at mollis in, ultrices quis dolor. Morbi gravida velit odio. Vivamus malesuada, enim sed ultricies convallis, dolor massa mollis libero, sit amet tempor mauris est id sem. Praesent vel nunc quam.
<br><br>
