...
<body>
    <div class="mainwrapper">
        ...
        <div class="bannerwrapper">
            <!--Image Banner-->
            <div class="banner">
                <img src="../contentimages/banner.jpg" width="320" height="160" />
            </div>
        </div>     
        <form action="JobSearch.aspx" method="get" data-ajax="false" id="sform">
         ...
         <div class="contentwrapper">
            <!--Content-->
            <div class="breadcrump">jobs   >  Jobs Details
                <div class="back-btn"><a href="jobs.aspx">
                    <img src="images/back-btn.png" width="62" height="26" /></a> </div>
            </div>
            <h1 style="margin-left: 10px;">Jobs Details </h1>                 
            <p style="padding: 10px;">Details</p>
        </div>
                
        <div class="footerwrapper"><a href="jobs" rel="external">View Full Site</a></div>
    </div>
</body>
</html>
