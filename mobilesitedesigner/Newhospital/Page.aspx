...
<body>
    <div data-role="page">
        ...
        <% 
           ...
           var SearchCol = (from o in GetDataContext2.TBL_Job_SearchResultsColVisible
        ...
        <div data-role="content">
            <ul data-role="listview">
                ...
                <li><a href="Title.aspx">Title</a></li>
                
                <li><a href="title.aspx">title</a></li>
                
                <li><a href="Page" rel="external">Go To Main Site</a></li>
            </ul>
        </div>
        <!-- /content -->
