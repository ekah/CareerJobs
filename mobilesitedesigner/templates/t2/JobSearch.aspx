...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(search))
            pg.Predicates.Add(Predicates.Field<mobilesitedesigner.Data.Standalone.VW_Jobs>(f => f.JobTitle, Operator.Like, search));
        ...
        <div data-role="content">
            <ul data-role="listview">
                <%  foreach (var item in _Jobs)
                    { %>
                <li><a href="JobSearchDetails.aspx?Job=<% =item.JobId %>&page=<% =_Page.Location %>"><% =item.JobTitle %></a></li>
                <% }  %>
